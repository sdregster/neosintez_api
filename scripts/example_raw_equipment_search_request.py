...
async def main():
    ...
    async with NeosintezClient(config) as client:
        ...
        # Создаем фильтры точно как в сырой нагрузке
        filters = [
        ...
        # Создаем условия точно как в сырой нагрузке
        conditions = [
            SearchCondition(
        ...
        try:
            ...
            # Сохраняем полный ответ в JSON (массив объектов)
            os.makedirs("data", exist_ok=True)
            output_file = "data/raw_search_results.json"
