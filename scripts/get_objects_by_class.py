...
async def save_objects_info_to_file(class_info: EntityClass, objects: List[Object], objects_attributes: List[Dict[str, Any]]) -> bool:
    """
...
async def main():
    ...
    parser.add_argument("--limit", type=int, default=10, help="Максимальное количество объектов для получения")
