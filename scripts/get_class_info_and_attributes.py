...
async def get_class_info_and_attributes(
    class_id: str,
) -> Tuple[Optional[EntityClass], List[Attribute]]:
    """
...
async def save_class_info_to_file(
    ...
    for attr in attributes:
        ...
        if attr.Type:
            attr_dict["type"] = {"id": attr.Type.Id, "name": attr.Type.Name}
...
async def main():
    ...
    if args.search:
        ...
        if len(matched_classes) == 1:
            ...
            print("Найден один класс, получаем информацию о его атрибутах...\n")
        else:
