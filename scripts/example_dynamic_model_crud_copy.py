...
from neosintez_api import NeosintezConfig
...
async def main():
    ...
    """
    user_defined_data = {
        "Класс": "Подобъект модели",
        "Имя объекта": "Динамическая стройка из фабрики",
        "Объект-аналог": "8681c50f-ec53-f011-91e6-005056b6948b",
    }
    ...
    try:
        ...
        created_object = await object_service.create(model_instance, parent_id="26cee35d-d6be-f011-91fa-005056b6948b")
